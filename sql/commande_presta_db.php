...
$SQL_COL_TEAM_COMMANDE_PRESTA           = "TEAM";
...
$SQL_SHOW_UPDATE_COMMANDE     =   "   $SQL_COL_ID_COMMANDE_PRESTA,     $SQL_COL_USER_ID_COMMANDE_PRESTA,    $SQL_COL_SOCIETE_COMMANDE_PRESTA ,     $SQL_COL_TEAM_COMMANDE_PRESTA,     $SQL_COL_PROFILE_COMMANDE_PRESTA,     $SQL_COL_STATUS_COMMANDE_PRESTA,     $SQL_COL_COMMANDE_COMMANDE_PRESTA,    $SQL_COL_DEBUT_COMMANDE_PRESTA,     $SQL_COL_FIN_COMMANDE_PRESTA,     $SQL_COL_ACHAT_COMMANDE_PRESTA,    $SQL_COL_VENTE_COMMANDE_PRESTA,     $SQL_COL_UO_COMMANDE_PRESTA,     $SQL_COL_COUT_COMMANDE_PRESTA,    $SQL_COL_VISIBLE_COMMANDE_PRESTA,    $SQL_COL_COMMENTAIRE_COMMANDE_PRESTA ";
$SQL_SHOW_UPDATE_COMMANDE_USER=   "   $SQL_COL_ID_COMMANDE_PRESTA,       NAME,   NOM,   PRENOM,             $SQL_COL_SOCIETE_COMMANDE_PRESTA ,     $SQL_COL_TEAM_COMMANDE_PRESTA,     $SQL_COL_PROFILE_COMMANDE_PRESTA,     $SQL_COL_STATUS_COMMANDE_PRESTA,     $SQL_COL_COMMANDE_COMMANDE_PRESTA,    $SQL_COL_DEBUT_COMMANDE_PRESTA,     $SQL_COL_FIN_COMMANDE_PRESTA,     $SQL_COL_ACHAT_COMMANDE_PRESTA,    $SQL_COL_VENTE_COMMANDE_PRESTA,     $SQL_COL_UO_COMMANDE_PRESTA,     $SQL_COL_COUT_COMMANDE_PRESTA,    $SQL_COL_VISIBLE_COMMANDE_PRESTA,    $SQL_COL_COMMENTAIRE_COMMANDE_PRESTA ";
$SQL_SELECT_UPDATE_COMMANDE_USER= "   cp.$SQL_COL_ID_COMMANDE_PRESTA,  u.NAME, u.NOM, u.PRENOM,          cp.$SQL_COL_SOCIETE_COMMANDE_PRESTA ,  cp.$SQL_COL_TEAM_COMMANDE_PRESTA,  cp.$SQL_COL_PROFILE_COMMANDE_PRESTA,  cp.$SQL_COL_STATUS_COMMANDE_PRESTA,  cp.$SQL_COL_COMMANDE_COMMANDE_PRESTA, cp.$SQL_COL_DEBUT_COMMANDE_PRESTA,  cp.$SQL_COL_FIN_COMMANDE_PRESTA,  cp.$SQL_COL_ACHAT_COMMANDE_PRESTA, cp.$SQL_COL_VENTE_COMMANDE_PRESTA,  cp.$SQL_COL_UO_COMMANDE_PRESTA,  cp.$SQL_COL_COUT_COMMANDE_PRESTA, cp.$SQL_COL_VISIBLE_COMMANDE_PRESTA, cp.$SQL_COL_COMMENTAIRE_COMMANDE_PRESTA ";
$SQL_SELECT_COL_COMMANDE_USER   = "  cp.$SQL_COL_ID_COMMANDE_PRESTA as ID, u.NOM, u.PRENOM,              cp.$SQL_COL_SOCIETE_COMMANDE_PRESTA ,  cp.$SQL_COL_TEAM_COMMANDE_PRESTA,  cp.$SQL_COL_PROFILE_COMMANDE_PRESTA,  cp.$SQL_COL_STATUS_COMMANDE_PRESTA,  cp.$SQL_COL_DEBUT_COMMANDE_PRESTA,    cp.$SQL_COL_FIN_COMMANDE_PRESTA, cp.$SQL_COL_ACHAT_COMMANDE_PRESTA, cp.$SQL_COL_VENTE_COMMANDE_PRESTA, cp.$SQL_COL_UO_COMMANDE_PRESTA, cp.$SQL_COL_COUT_COMMANDE_PRESTA, cp.$SQL_COL_VISIBLE_COMMANDE_PRESTA, cp.$SQL_COL_COMMENTAIRE_COMMANDE_PRESTA ";
...
function applyGestionCommandePrestataire() {
    ...
    global $SQL_COL_TEAM_COMMANDE_PRESTA;
    ...
    $action = getActionGet();
    $groupe = getURLVariable("$SQL_COL_TEAM_COMMANDE_PRESTA");
