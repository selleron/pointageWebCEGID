...
$SQL_CONDITION_CEGID_FILE2 = "'$SQL_COL_FILE_CEGID_FILE'='$SQL_COL_ID_FILE' AND '$SQL_COL_VERSION_CEGID_FILE'='$SQL_COL_VERSION_FILE'";
...
function applyGestionCEGID_FILE() {
    ...
    global $SQL_SHOW_ALL_COL_CEGID_FILE;
    $colCEGID_FILE = $SQL_SHOW_ALL_COL_CEGID_FILE;
