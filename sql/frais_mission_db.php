...
$SQL_COL_FRAIS_NON_REMBOURSABLE_FRAIS_MISSION = "NON_REMBOURSABLE";
$SQL_COL_COUT_FRAIS_MISSION                   = "FRAIS";

$SQL_SHOW_COL_FRAIS_MISSION   = "   $SQL_COL_ID_FRAIS_MISSION,                                $SQL_COL_DATE_FRAIS_MISSION,                                    $SQL_COL_PROJECT_ID_COUT_PROJECT,                               $SQL_COL_TITRE_FRAIS_MISSION,    $SQL_COL_FRAIS_LOCAL_FRAIS_MISSION,                                          $SQL_COL_FRAIS_NON_REMBOURSABLE_FRAIS_MISSION,    $SQL_COL_COUT_FRAIS_MISSION,                                   $SQL_COL_FRAIS_MISSION_COMMENT,                                      $SQL_COL_STATUS_FRAIS_MISSION";
$SQL_SHOW_COL_FRAIS_MISSION2  = "   $SQL_COL_ID_FRAIS_MISSION,                                $SQL_COL_DATE_FRAIS_MISSION,                                    $SQL_COL_PROJECT_NAME_COUT_PROJECT,                             $SQL_COL_TITRE_FRAIS_MISSION,    $SQL_COL_FRAIS_LOCAL_FRAIS_MISSION,                                          $SQL_COL_FRAIS_NON_REMBOURSABLE_FRAIS_MISSION,    $SQL_COL_COUT_FRAIS_MISSION,                                   $SQL_COL_FRAIS_MISSION_COMMENT,                                      $SQL_COL_STATUS_FRAIS_MISSION";
$SQL_SELECT_COL_FRAIS_MISSION = "pc.$SQL_COL_ID_FRAIS_MISSION as $SQL_COL_ID_FRAIS_MISSION, pc.$SQL_COL_DATE_FRAIS_MISSION as $SQL_COL_DATE_FRAIS_MISSION, pj.$SQL_COL_NAME_PROJECT as $SQL_COL_PROJECT_NAME_COUT_PROJECT, pc.$SQL_COL_TITRE_FRAIS_MISSION, pc.$SQL_COL_FRAIS_LOCAL_FRAIS_MISSION as $SQL_COL_FRAIS_LOCAL_FRAIS_MISSION, pc.$SQL_COL_FRAIS_NON_REMBOURSABLE_FRAIS_MISSION, pc.$SQL_COL_COUT_FRAIS_MISSION as $SQL_COL_COUT_FRAIS_MISSION, pc.$SQL_COL_FRAIS_MISSION_COMMENT as $SQL_COL_FRAIS_MISSION_COMMENT, pc.$SQL_COL_STATUS_FRAIS_MISSION as $SQL_COL_STATUS_FRAIS_MISSION";
