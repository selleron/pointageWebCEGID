...
$SQL_COL_ETAP_CEGID_USER          = "ETAP";

$SQL_SHOW_COL_INFO_CEGID_USER = "$SQL_COL_EMAIL1_CEGID_USER, $SQL_COL_EMAIL2_CEGID_USER, $SQL_COL_TEL1_CEGID_USER, $SQL_COL_TEL2_CEGID_USER, $SQL_COL_GROUPE_CEGID_USER, $SQL_COL_TEAM_CEGID_USER, $SQL_COL_LOCALISATION_CEGID_USER,  $SQL_COL_CEGID_ID_CEGID_USER, $SQL_COL_ETAP_CEGID_USER";


$SQL_SHOW_BEGIN_COL_CEGID_USER   = "$SQL_COL_ID_CEGID_USER, $SQL_COL_NAME_CEGID_USER, $SQL_COL_NOM_CEGID_USER, $SQL_COL_PRENOM_CEGID_USER, $SQL_COL_SOCIETE_CEGID_USER, $SQL_COL_GROUPE_CEGID_USER";
$SQL_SHOW_SHORT_COL_CEGID_USER   = "$SQL_SHOW_BEGIN_COL_CEGID_USER,  $SQL_COL_STATUS_CEGID_USER";
...
function applyGestionUserCEGID() {
  ...
  * - pas d'insertion
  * - edition possible
  * @param string $condition            (utilisé pour filter sur les user visible) 
  * @param string $columnsShowed        liste des colonnes à afficher, peut etre a ""
  */
 function showShortTableUserCEGID($condition="", $columnsShowed="") {
     ...
     if ($columnsShowed==""){
         $columnsShowed=$SQL_SHOW_SHORT_COL_CEGID_USER;
     }
     
     //showTable($SQL_TABLE_CEGID_USER, $SQL_SHOW_COL_CEGID_USER, $form_name);
     $param = prepareshowTable($SQL_TABLE_CEGID_USER, $columnsShowed, $form_name, $condition);
     $param[PARAM_TABLE_ACTION::TABLE_EXPORT_CSV] = "yes";
