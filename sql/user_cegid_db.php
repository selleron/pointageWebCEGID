...
$SQL_SHOW_COL_CEGID_USER         = "$SQL_COL_ID_CEGID_USER, $SQL_COL_NAME_CEGID_USER, $SQL_COL_NOM_CEGID_USER, $SQL_COL_PRENOM_CEGID_USER, $SQL_COL_PROFIL_CEGID_USER, $SQL_COL_SOCIETE_CEGID_USER,  $SQL_COL_STATUS_CEGID_USER, $SQL_COL_ARRIVEE_CEGID_USER, $SQL_COL_DEPART_CEGID_USER, $SQL_COL_VISIBLE_CEGID_USER";
