...
$SQL_SHOW_COL_DEVIS     = "$SQL_COL_ID_DEVIS, $SQL_COL_NAME_DEVIS, $SQL_COL_VERSION_DEVIS, $SQL_COL_STATUS_DEVIS, $SQL_COL_COMMANDE_DEVIS, $SQL_COL_MODIFICATION_DEVIS, $SQL_COL_CEGID_DEVIS";
