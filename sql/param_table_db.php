...
class PARAM_TABLE extends PARAM_TABLE_TABLE {
...
class PARAM_TABLE_SQL {
    ...
    const TABLE_NAME = PARAM_TABLE::TABLE_NAME;
...
$TABLE_NAME = PARAM_TABLE::TABLE_NAME;
...
class PARAM_TABLE_ACTION {
    const ACTIONS_AT_LEFT = "TABLE_ACTIONS_AT_LEFT";
