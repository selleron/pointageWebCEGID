...
UPDATE `version` SET `DATE` = '2018-04-27 00:00:00', `value` = '0.29.0' WHERE `version`.`id` = 'database';
INSERT INTO `version` (`id`, `order`, `DATE`, `description`, `value`) VALUES ('patch_database_0.28_vers_0.29', '101', '2018-04-27 00:00:00', 'correction requestes Resp. Affaires', '0.28.0');
