...
DELETE FROM `cegid_requetes` WHERE `cegid_requetes`.`ID` = 'Actuel CA_projet';
DELETE FROM `cegid_requetes` WHERE `cegid_requetes`.`ID` = 'Actuel CA_projet_clos';
DELETE FROM `cegid_requetes` WHERE `cegid_requetes`.`ID` = 'Previsionnel CA_projet';
DELETE FROM `cegid_requetes` WHERE `cegid_requetes`.`ID` = 'Previsionnel CA_projet_clos';
DELETE FROM `cegid_requetes` WHERE `cegid_requetes`.`ID` = 'diff CA';
DELETE FROM `cegid_requetes` WHERE `cegid_requetes`.`ID` = 'diff CA 2017';
