...
--
ALTER TABLE `cegid_project` ADD `TYPE` VARCHAR(15) NOT NULL DEFAULT 'Undefined' AFTER `STATUS`;
ALTER TABLE `cegid_project` ADD FOREIGN KEY (`TYPE`) REFERENCES `cegid_type_project`(`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE `cegid_project` ADD `GROUPE` VARCHAR(50) NULL AFTER `TYPE`; 
ALTER TABLE `cegid_project` ADD INDEX(`GROUPE`);
