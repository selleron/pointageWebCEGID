...
<head>
  <title> Responsable Affaires</title>
  <?PHP 
...
<body>
<div id="header">
  <h1>Serveur Web Pointage : Responsable Affaires</h1>
</div>
...
<div id="contenu">
  	...
  	<?PHP 
	showBandeauHeaderPage("Responsable Affaires");
	?>
...
<?php
	echo "<p>Responsable Affaires<br/></p>";
	showTracePOST();
	...
	applyGestionCAPrevisionel( $ID_REQUETE_SQL_CA_RESPONSABLE_AFFAIRES );
	showTableCAPrevisionel( $ID_REQUETE_SQL_CA_RESPONSABLE_AFFAIRES );
?>
<br/><br/><br/>
